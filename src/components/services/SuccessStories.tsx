...
export default function SuccessStories() {
  ...
  <div className="mx-auto max-w-7xl px-6">
    ...
    <div className="mx-auto mb-20 max-w-3xl text-center">
      <span className="inline-flex rounded-full border border-gold/30 bg-transparent px-4 py-2 text-xs font-semibold uppercase tracking-[0.25em] text-gold">
        Success Stories
      </span>
    ...
    <div className="space-y-28">
      {stories.map((story, index) => (
        ...
        >
          ...
          {/* Image */}
          <div className="group relative overflow-hidden rounded-3xl shadow-xl transition-all duration-500 hover:shadow-2xl hover:shadow-gold/10">
            <Image
              src={story.image}
              alt={story.title}
              width={800}
          ...
          <div>
            ...
            <span className="inline-block text-sm font-semibold uppercase tracking-[0.25em] text-gold transition-all duration-300 group-hover:tracking-[0.35em]">
              Case Study
            </span>

            <h3 className="mt-3 text-3xl font-bold leading-tight text-primary">
              {story.title}
            </h3>
            ...
            {/* Accent */}
            <div className="mt-10 h-1 w-24 rounded-full bg-gradient-to-r from-gold to-primary transition-all duration-500 group-hover:w-40" />
