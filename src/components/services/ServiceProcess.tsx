  ...
  <div className="mx-auto max-w-5xl px-6">
    ...
    <div className="mt-20 grid items-start gap-20 lg:grid-cols-[0.9fr_1.1fr]">
      ...
      <div>
        ...
        <h2 className="mt-5 text-5xl font-bold leading-tight text-primary">
          A Simple &
          <br />
          Structured
          <br />
            ...
            >
              ...
              <div className="flex flex-col items-center self-stretch">
                ...
                {index !== data.steps.length - 1 && (
                  <div className="mt-2 h-10 w-[2px] bg-gradient-to-b from-gold via-gold/50 to-border" />
                )}
              ...
              <div className="pb-9">
                ...
                <span className="text-md font-semibold uppercase tracking-[0.2em] text-gold">
