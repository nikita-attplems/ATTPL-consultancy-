...
Ecosystem.`;
  ...
  return (
    <section ref={sectionRef} className="bg-background py-16 md:py-20 lg:py-24">
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-10">
        <div className="grid w-full grid-cols-1 items-center gap-8 lg:grid-cols-2 xl:gap-16">
          ...
          <div className="w-full max-w-[560px] mx-auto text-center lg:mx-0 lg:max-w-none lg:text-left">
            <h2 className="mt-4 whitespace-pre-line text-[clamp(2.2rem,3.3vw,3.8rem)] font-bold leading-[1.05] text-primary">
              {typedText}
            ...
            {showButton && (
              <div className="mt-8 flex justify-center lg:justify-start animate-slide-right">
                <Button href="/service-form">Get Started</Button>
              </div>
            )}
          </div>
          ...
          <div className="mt-12 flex justify-center lg:mt-0 lg:justify-end">
            ...
            "
              ...
              <div className="absolute left-1/2 top-1/2 z-30 -translate-x-1/2 -translate-y-1/2">
                ...
                relative
                flex
                h-[clamp(110px,24vw,210px)]
                w-[clamp(110px,24vw,210px)]
                items-center
                justify-center
                rounded-full
                bg-surface
            ...
            "
              >
                ...
                <div className="absolute left-0 top-1/2 h-px w-1/2 bg-border" />
                <div className="absolute right-0 top-1/2 h-px w-1/2 bg-border" />
                <div className="absolute bottom-0 left-1/2 h-1/2 w-px bg-border" />
              </div>
